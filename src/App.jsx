...
function App() {
  ...
  const friends = [
    ...
    {name: 'Meta ⛏', icon: '/meta.webp', status: 'offline'}, 
    ...
    {name: 'Gli7ch', icon: '/glitch.webp', status: 'offline'}, 
    {name: 'Saibot', icon: '/saibot.webp', status: 'offline'}, 
    ...
    {name: 'johnald', icon: '/johnald.webp', status: 'offline'}, 
    ...
    {name: 'LemonsByte', icon: '/lemon.webp', status: 'offline'}, 
  ...
  const servers = [
    ...
    {name: 'fortnite', icon: '/fortnite.png', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: '/fortnite.webp'},
    ...
    {name: 'minecraft', icon: 'https://cdn.discordapp.com/icons/302094807046684672/24f8bc7ec317e6eaaa0d8352720a7dfe.webp?size=128', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: '/minecraft.webp'},
    {name: 'lofi girl', icon: '/lofi.png', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: lofiGirl}, 
    ...
    {name: 'voltaic', icon: '/voltaic.png', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: '/voltaic.webp'},
