...
function App() {
  ...
  const servers = [
    ...
    {name: 'fortnite', icon: '/fortnite.png', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: 'https://cdn.discordapp.com/banners/322850917248663552/15d4568ce46f51e446e801c2c1801211.webp?size=300'},
    ...
    {name: 'voltaic', icon: '/voltaic.png', iconType: 'image', background: '', notifications: '', hoverColor: '', type: '', banner: 'https://cdn.discordapp.com/banners/153919886471593984/a_bf41f7fd689b07d9026fdec37e39104d.gif?size=300'},
